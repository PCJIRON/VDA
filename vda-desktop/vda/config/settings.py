...
from vda.config.defaults import DEFAULT_SETTINGS
...
class Settings:
    ...
    def _get_default_config_path(self) -> Path:
        ...
        if is_windows():
            ...
            base = Path.home() / "Library" / "Preferences" / "VDADesktop"
        elif is_linux():
            base = Path.home() / ".config" / "vda-desktop"
        else:
            base = Path.home() / ".vda-desktop"
