...
This guide provides test procedures for verifying VDA Desktop across all supported platforms.
...
**Expected:**
- Conversation saves to `~/.vda-desktop/conversations/`
- Messages restore correctly
- Attachments noted (but not re-loaded)

**Platform Notes:**
- **Windows:** Path: `C:\Users\%USER%\AppData\Local\VDA\`
- **macOS:** Path: `~/Library/Preferences/VDA/`
- **Linux:** Path: `~/.config/vda-desktop/`
