# Release Notes - VDA Desktop v0.4.0
...
VDA Desktop v0.4.0 is a complete, production-ready desktop application for chatting with VDA AI models. This release includes **4 major phases** of development:
...
**Note:** Your saved conversations and settings are preserved in `~/.vda-desktop/`.

---

## 🙏 Acknowledgments

Thanks to all contributors and the VDA community!
