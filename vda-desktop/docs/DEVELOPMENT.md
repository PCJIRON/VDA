...
│   ├── __main__.py         # Entry point (py -m vda)
...
py -c "from vda.app import VDADesktopApp; import sys; app = VDADesktopApp(sys.argv); app.run()"
```
...
1. Create file in `vda/ui/components/`
...
```python
# vda/ui/components/my_widget.py
from PyQt6.QtWidgets import QWidget
...
import pytest
from vda.utils.my_feature import my_function
