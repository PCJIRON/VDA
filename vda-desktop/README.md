...
A PyQt-based desktop application for VDA AI assistant, bringing the VDA Code CLI experience to a native GUI environment.
...
- 🔐 **OAuth Authentication** - Secure login with VDA/Google account (1,000 free requests/day)
- 📎 **File Attachments** - Drag-and-drop files for code review and analysis
- 💬 **Real-time Chat** - Stream responses from VDA AI models
...
# Run with coverage
py -m pytest tests/ --cov=vda --cov-report=html
...
- Based on [vda-code](https://github.com/VDALM/vda-code) CLI extension
...
- **Repository:** https://github.com/YOUR_USERNAME/vda-desktop
...
- **Documentation:** https://github.com/YOUR_USERNAME/vda-desktop/tree/main/docs
