# Phase 1 Plan: Wave 1 - Enhanced Vision Mode (Qwen Only)
...
Enhance existing vision mode with better prompt engineering and structured JSON output.

**NO OpenCV in Wave 1** - Start simple, add OpenCV in Wave 2!
...
```python
# Enhanced system prompt for coordinate prediction
...
**Expected Accuracy:** ~50% (good for simple clicks, NOT painting)
