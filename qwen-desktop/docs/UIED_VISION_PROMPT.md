...
## Purpose:
Qwen Vision will analyze the ACTUAL SCREENSHOT and provide EXTREMELY DETAILED labels for visual template matching.
...
1. **Vision-First Approach**: Qwen SEES the actual screenshot
