...
4. [Using Qwen Desktop](#using-qwen-desktop)
...
Qwen Desktop is a native desktop application for chatting with Qwen AI models. It provides:
...
Qwen Desktop uses OAuth for free tier access (1,000 requests/day).
...
3. Sign in with your Qwen/Google account
...
2. Conversation saves to `~/.qwen-desktop/conversations/`
...
3. Check folder exists: `~/.qwen-desktop/conversations/`
...
**A:** 
- **Windows:** `C:\Users\%USER%\AppData\Local\Qwen\Qwen Desktop\conversations\`
- **macOS:** `~/Library/Preferences/Qwen/conversations/`
- **Linux:** `~/.config/qwen-desktop/conversations/`
